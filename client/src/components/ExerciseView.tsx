...
const ExerciseView = ({isOpen, onClose} : any) => {
                    ...
                    <div className='Container'>
                        ...
                        <div className="row">
                            <Form.Group className="mb-3">
                                ...
                                <Form.Control placeholder="Enter weight" readOnly/>
                            </Form.Group>
                        </div>
                        <div className="row">
                            <Form.Group className="mb-3">
                                <Form.Label>Sets</Form.Label>
                                <Form.Control placeholder="Enter sets" readOnly/>
                            </Form.Group>
                        </div>
                        <div className="row">
                            <Form.Group className="mb-3">
                                <Form.Label>Reps</Form.Label>
                                <Form.Control placeholder="Enter reps" readOnly/>
                            </Form.Group>
                        </div>
                    </div>
                </Modal.Body>
